...
<?php
  ...
  /* Uncomment when using SASL authentication mechanisms */
	...
	*/
	...
	$pop3=new pop3_class;
	$pop3->hostname="minos.servidoraweb.net";             /* POP 3 server host name                      */
	...
	$user="info@voiptelefonia.com.ar";                        /* Authentication user name                    */
	$password="rqk430";                    /* Authentication password                     */
