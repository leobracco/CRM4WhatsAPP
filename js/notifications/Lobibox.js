...
//------------------------------------------------------------------------------
    ...
    Lobibox.notify.DEFAULTS = {
        ...
        showAfterPrevious: true,   // Set this to true if you want notification not to be shown until previous notification is closed. This is useful for notification queues
    ...
    Lobibox.notify.OPTIONS = {
        ...
        icons: {
            ...
            fontAwesome: {
                ...
                warning: 'fa fa-exclamation-circle',
                info: 'fa fa-info-circle',
                hospital:'fas fa-user-md',
                police:'fas fa-user-md',
                emergencia:'fas fa-user-md',
                vdg:'fas fa-user-md'
